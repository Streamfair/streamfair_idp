...
func RegisterIdentityProviderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IdentityProviderServer) error {
	...
	mux.Handle("POST", pattern_IdentityProvider_LoginUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.IdentityProvider/LoginUser", runtime.WithHTTPPathPattern("/streamfair/v1/login_user"))
		if err != nil {
...
func RegisterIdentityProviderHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IdentityProviderClient) error {
	...
	mux.Handle("POST", pattern_IdentityProvider_LoginUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.IdentityProvider/LoginUser", runtime.WithHTTPPathPattern("/streamfair/v1/login_user"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
