...
import (
	...
	"github.com/Streamfair/streamfair_idp_svc/gapi"
...
func main() {
	fmt.Println("Hello, Streamfair Identity Provider Service!")
...
func runGrpcServer(config util.Config, store db.Store) {
	...
	pb.RegisterIdentityProviderServiceServer(grpcServer, server)
