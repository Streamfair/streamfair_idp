...
type Config struct {
	...
	DBSourceLocal        string        `mapstructure:"DB_SOURCE_IDP_LOCAL"`
...
func LoadConfig() (config Config, err error) {
	...
	keys := []string{
		...
		"DB_SOURCE_IDP_LOCAL",
		"MIGRATION_URL",
		"HTTP_SERVER_ADDRESS_IDP",
		"GRPC_SERVER_ADDRESS_IDP",
		"TOKEN_SYMMETRIC_KEY",
	...
	config.DBSource = viper.GetString("DB_SOURCE_IDP")
	config.DBSourceLocal = viper.GetString("DB_SOURCE_IDP_LOCAL")
	config.MigrationURL = viper.GetString("MIGRATION_URL")
	config.HttpServerAddress = viper.GetString("HTTP_SERVER_ADDRESS_IDP")
	config.GrpcServerAddress = viper.GetString("GRPC_SERVER_ADDRESS_IDP")
