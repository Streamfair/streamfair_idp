...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (IdpSvcUser, error) {
...
SELECT id, username, full_name, email, password_hash, password_salt, country_code, role_id, status, last_login_at, username_changed_at, email_changed_at, password_changed_at, created_at, updated_at FROM "idp_svc"."Users"
WHERE id = $1 LIMIT 1
`

func (q *Queries) GetUserByID(ctx context.Context, id int64) (IdpSvcUser, error) {
...
func (q *Queries) GetUserByUsername(ctx context.Context, username string) (IdpSvcUser, error) {
